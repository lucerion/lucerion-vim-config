...
if plugin#loaded('vim-fugitive')
  set statusline+=\ %{fugitive#statusline()}
endif
if plugin#loaded('vim-smartword')
...
" ctrlp-py-matcher
if plugin#loaded('ctrlp-py-matcher')
